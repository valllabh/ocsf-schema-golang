...
const (
	COMPLIANCE_FINDING_CONFIDENCE_ID_COMPLIANCE_FINDING_CONFIDENCE_ID_UNKNOWN COMPLIANCE_FINDING_CONFIDENCE_ID = 0  // EnumValue: 0; Type: OCSF_VALUE;
...
const (
	...
	COMPLIANCE_FINDING_TYPE_UID_COMPLIANCE_FINDING_TYPE_UID_COMPLIANCE_FINDING_CREATE  COMPLIANCE_FINDING_TYPE_UID = 200301 // EnumValue: 200301; Type: OCSF_VALUE;
...
const (
	...
	DATA_SECURITY_FINDING_ACTION_ID_DATA_SECURITY_FINDING_ACTION_ID_DENIED  DATA_SECURITY_FINDING_ACTION_ID = 2  // EnumValue: 2; Type: OCSF_VALUE;
...
const (
	...
	DATA_SECURITY_FINDING_RISK_LEVEL_ID_DATA_SECURITY_FINDING_RISK_LEVEL_ID_OTHER    DATA_SECURITY_FINDING_RISK_LEVEL_ID = 99 // EnumValue: 99; Type: OCSF_VALUE;
)
...
const (
	...
	DETECTION_FINDING_CONFIDENCE_ID_DETECTION_FINDING_CONFIDENCE_ID_OTHER   DETECTION_FINDING_CONFIDENCE_ID = 99 // EnumValue: 99; Type: OCSF_VALUE;
)
...
const (
	...
	INCIDENT_FINDING_IMPACT_ID_INCIDENT_FINDING_IMPACT_ID_CRITICAL INCIDENT_FINDING_IMPACT_ID = 4  // EnumValue: 4; Type: OCSF_VALUE;
...
const (
	...
	INCIDENT_FINDING_PRIORITY_ID_INCIDENT_FINDING_PRIORITY_ID_OTHER    INCIDENT_FINDING_PRIORITY_ID = 99 // EnumValue: 99; Type: OCSF_VALUE;
)
...
const (
	...
	INCIDENT_FINDING_SEVERITY_ID_INCIDENT_FINDING_SEVERITY_ID_CRITICAL      INCIDENT_FINDING_SEVERITY_ID = 5  // EnumValue: 5; Type: OCSF_VALUE;
...
const (
	...
	INCIDENT_FINDING_VERDICT_ID_INCIDENT_FINDING_VERDICT_ID_BENIGN             INCIDENT_FINDING_VERDICT_ID = 5  // EnumValue: 5; Type: OCSF_VALUE;
...
const (
	...
	VULNERABILITY_FINDING_TYPE_UID_VULNERABILITY_FINDING_TYPE_UID_VULNERABILITY_FINDING_UNKNOWN VULNERABILITY_FINDING_TYPE_UID = 200200 // EnumValue: 200200; Type: OCSF_VALUE;
...
const file_ocsf_v1_3_0_events_findings_enums_enums_proto_rawDesc = "" +
	"\n" +
	"-ocsf/v1_3_0/events/findings/enums/enums.proto\x12!ocsf.v1_3_0.events.findings.enums*\xf6\x01\n" +
	...
	"&COMPLIANCE_FINDING_CONFIDENCE_ID_OTHER\x10c*\xfb\x02\n" +
	...
	"$COMPLIANCE_FINDING_SEVERITY_ID_OTHER\x10c*\x9c\x02\n" +
	...
	"4COMPLIANCE_FINDING_TYPE_UID_COMPLIANCE_FINDING_OTHER\x10ϝ\f*\xd2\x01\n" +
	...
	"%DATA_SECURITY_FINDING_IMPACT_ID_OTHER\x10c*\xbf\x02\n" +
	...
	"'DATA_SECURITY_FINDING_SEVERITY_ID_OTHER\x10c*\xb1\x02\n" +
	...
	":DATA_SECURITY_FINDING_TYPE_UID_DATA_SECURITY_FINDING_OTHER\x10\xfb\x9f\f*\xbe\x01\n" +
	...
	"!DETECTION_FINDING_IMPACT_ID_OTHER\x10c*\xa3\x02\n" +
	...
	"#DETECTION_FINDING_SEVERITY_ID_OTHER\x10c*\x95\x02\n" +
	...
	"2DETECTION_FINDING_TYPE_UID_DETECTION_FINDING_OTHER\x10\xb3\x9e\f*\xb4\x01\n" +
	...
	"\x1bFINDING_CONFIDENCE_ID_OTHER\x10c*\x98\x02\n" +
	...
	"\x19FINDING_SEVERITY_ID_OTHER\x10c*\xcf\x01\n" +
	...
	"\x1aFINDING_STATUS_ID_RESOLVED\x10\x04\x12\x1b\n" +
	...
	"\x1eFINDING_TYPE_UID_FINDING_OTHER\x10\xa3\x9b\f*\xea\x01\n" +
	...
	"$INCIDENT_FINDING_CONFIDENCE_ID_OTHER\x10c*\x83\x02\n" +
	...
	"\"INCIDENT_FINDING_PRIORITY_ID_OTHER\x10c*\xe9\x02\n" +
	...
	"\x12%\n" +
	"!INCIDENT_FINDING_VERDICT_ID_OTHER\x10c*\xea\x01\n" +
	...
	"0SECURITY_FINDING_TYPE_UID_SECURITY_FINDING_OTHER\x10\x87\x9c\f*\x88\x02\n" +
	...
	")VULNERABILITY_FINDING_CONFIDENCE_ID_OTHER\x10c*\x96\x03\n" +
	...
	"'VULNERABILITY_FINDING_SEVERITY_ID_OTHER\x10c*\xb1\x02\n" +
	...
	":VULNERABILITY_FINDING_TYPE_UID_VULNERABILITY_FINDING_OTHER\x10\xeb\x9c\fB\x9f\x02\n" +
	"%com.ocsf.v1_3_0.events.findings.enumsB\n" +
	"EnumsProtoP\x01ZHgithub.com/valllabh/ocsf-schema-golang/ocsf/v1_3_0/events/findings/enums\xa2\x02\x05OVEFE\xaa\x02\x1fOcsf.V130.Events.Findings.Enums\xca\x02\x1fOcsf\\V130\\Events\\Findings\\Enums\xe2\x02+Ocsf\\V130\\Events\\Findings\\Enums\\GPBMetadata\xea\x02#Ocsf::V130::Events::Findings::Enumsb\x06proto3"
...
func file_ocsf_v1_3_0_events_findings_enums_enums_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_ocsf_v1_3_0_events_findings_enums_enums_proto_rawDesc), len(file_ocsf_v1_3_0_events_findings_enums_enums_proto_rawDesc)),
			NumEnums:      63,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
