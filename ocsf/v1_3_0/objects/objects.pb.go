...
type Device struct {
	...
	NamespacePid      int32                      `protobuf:"varint,28,opt,name=namespace_pid,json=namespacePid,proto3" json:"namespace_pid,omitempty"`                                                    // Profile: container; Caption: Namespace PID;
