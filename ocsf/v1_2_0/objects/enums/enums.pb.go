...
const (
	...
	ACCOUNT_TYPE_ID_ACCOUNT_TYPE_ID_LINUX_ACCOUNT    ACCOUNT_TYPE_ID = 9  // EnumValue: 9; Type: OCSF_VALUE;
	ACCOUNT_TYPE_ID_ACCOUNT_TYPE_ID_AWS_ACCOUNT      ACCOUNT_TYPE_ID = 10 // Type: OCSF_VALUE; EnumValue: 10;
	ACCOUNT_TYPE_ID_ACCOUNT_TYPE_ID_OTHER            ACCOUNT_TYPE_ID = 99 // EnumValue: 99; Type: OCSF_VALUE;
)
...
const (
	...
	ANALYTIC_TYPE_ID_ANALYTIC_TYPE_ID_RULE                ANALYTIC_TYPE_ID = 1  // EnumValue: 1; Type: OCSF_VALUE;
	...
	ANALYTIC_TYPE_ID_ANALYTIC_TYPE_ID_TAGGING             ANALYTIC_TYPE_ID = 6  // EnumValue: 6; Type: OCSF_VALUE;
	ANALYTIC_TYPE_ID_ANALYTIC_TYPE_ID_KEYWORD_MATCH       ANALYTIC_TYPE_ID = 7  // Type: OCSF_VALUE; EnumValue: 7;
	ANALYTIC_TYPE_ID_ANALYTIC_TYPE_ID_REGULAR_EXPRESSIONS ANALYTIC_TYPE_ID = 8  // EnumValue: 8; Type: OCSF_VALUE;
	...
	ANALYTIC_TYPE_ID_ANALYTIC_TYPE_ID_OTHER               ANALYTIC_TYPE_ID = 99 // EnumValue: 99; Type: OCSF_VALUE;
)
...
const (
	...
	DATA_SECURITY_CONFIDENTIALITY_ID_DATA_SECURITY_CONFIDENTIALITY_ID_PRIVATE          DATA_SECURITY_CONFIDENTIALITY_ID = 5  // EnumValue: 5; Type: OCSF_VALUE;
...
const (
	...
	DNS_ANSWER_FLAG_IDS_DNS_ANSWER_FLAG_IDS_TRUNCATED_RESPONSE   DNS_ANSWER_FLAG_IDS = 2  // EnumValue: 2; Type: OCSF_VALUE;
...
const (
	...
	FILE_CONFIDENTIALITY_ID_FILE_CONFIDENTIALITY_ID_TOP_SECRET       FILE_CONFIDENTIALITY_ID = 4  // EnumValue: 4; Type: OCSF_VALUE;
	...
	FILE_CONFIDENTIALITY_ID_FILE_CONFIDENTIALITY_ID_OTHER            FILE_CONFIDENTIALITY_ID = 99 // EnumValue: 99; Type: OCSF_VALUE;
)
...
const (
	...
	KILL_CHAIN_PHASE_PHASE_ID_KILL_CHAIN_PHASE_PHASE_ID_WEAPONIZATION         KILL_CHAIN_PHASE_PHASE_ID = 2  // EnumValue: 2; Type: OCSF_VALUE;
...
const (
	...
	MALWARE_CLASSIFICATION_IDS_MALWARE_CLASSIFICATION_IDS_KEYLOGGER               MALWARE_CLASSIFICATION_IDS = 9  // EnumValue: 9; Type: OCSF_VALUE;
	...
	MALWARE_CLASSIFICATION_IDS_MALWARE_CLASSIFICATION_IDS_WORM                    MALWARE_CLASSIFICATION_IDS = 22 // EnumValue: 22; Type: OCSF_VALUE;
...
const (
	...
	NETWORK_CONNECTION_INFO_BOUNDARY_ID_NETWORK_CONNECTION_INFO_BOUNDARY_ID_VIRTUAL_PRIVATE_GATEWAY NETWORK_CONNECTION_INFO_BOUNDARY_ID = 6  // EnumValue: 6; Type: OCSF_VALUE;
...
const (
	...
	NETWORK_INTERFACE_TYPE_ID_NETWORK_INTERFACE_TYPE_ID_TUNNEL   NETWORK_INTERFACE_TYPE_ID = 4  // EnumValue: 4; Type: OCSF_VALUE;
...
const (
	...
	NETWORK_PROXY_TYPE_ID_NETWORK_PROXY_TYPE_ID_MOBILE   NETWORK_PROXY_TYPE_ID = 5  // EnumValue: 5; Type: OCSF_VALUE;
	NETWORK_PROXY_TYPE_ID_NETWORK_PROXY_TYPE_ID_VIRTUAL  NETWORK_PROXY_TYPE_ID = 6  // EnumValue: 6; Type: OCSF_VALUE;
...
const (
	...
	OBSERVABLE_TYPE_ID_OBSERVABLE_TYPE_ID_OTHER   OBSERVABLE_TYPE_ID = 99 // EnumValue: 99; Type: OCSF_VALUE;
)
...
const (
	...
	OS_TYPE_ID_OS_TYPE_ID_I_OS           OS_TYPE_ID = 301 // EnumValue: 301; Type: OCSF_VALUE;
...
const (
	...
	REPUTATION_SCORE_ID_REPUTATION_SCORE_ID_MALICIOUS          REPUTATION_SCORE_ID = 10 // EnumValue: 10; Type: OCSF_VALUE;
...
const (
	...
	SCAN_TYPE_ID_SCAN_TYPE_ID_ELAM              SCAN_TYPE_ID = 7  // EnumValue: 7; Type: OCSF_VALUE;
...
const (
	...
	URL_CATEGORY_IDS_URL_CATEGORY_IDS_REFERENCE                       URL_CATEGORY_IDS = 49  // EnumValue: 49; Type: OCSF_VALUE;
	...
	URL_CATEGORY_IDS_URL_CATEGORY_IDS_AUDIO_VIDEO_CLIPS               URL_CATEGORY_IDS = 84  // EnumValue: 84; Type: OCSF_VALUE;
	...
	URL_CATEGORY_IDS_URL_CATEGORY_IDS_UNCATEGORIZED                   URL_CATEGORY_IDS = 90  // EnumValue: 90; Type: OCSF_VALUE;
	...
	URL_CATEGORY_IDS_URL_CATEGORY_IDS_NON_VIEWABLE_INFRASTRUCTURE     URL_CATEGORY_IDS = 96  // EnumValue: 96; Type: OCSF_VALUE;
	...
	URL_CATEGORY_IDS_URL_CATEGORY_IDS_ONLINE_MEETINGS                 URL_CATEGORY_IDS = 111 // EnumValue: 111; Type: OCSF_VALUE;
...
const (
	...
	WIN_RESOURCE_TYPE_ID_WIN_RESOURCE_TYPE_ID_FILE                      WIN_RESOURCE_TYPE_ID = 7  // EnumValue: 7; Type: OCSF_VALUE;
	...
	WIN_RESOURCE_TYPE_ID_WIN_RESOURCE_TYPE_ID_DEBUG_OBJECT              WIN_RESOURCE_TYPE_ID = 12 // EnumValue: 12; Type: OCSF_VALUE;
	WIN_RESOURCE_TYPE_ID_WIN_RESOURCE_TYPE_ID_FILTER_COMMUNICATION_PORT WIN_RESOURCE_TYPE_ID = 13 // EnumValue: 13; Type: OCSF_VALUE;
