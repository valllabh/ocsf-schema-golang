...
const (
	BASE_EVENT_STATUS_ID_BASE_EVENT_STATUS_ID_UNKNOWN BASE_EVENT_STATUS_ID = 0  // EnumValue: 0; Type: OCSF_VALUE;
	BASE_EVENT_STATUS_ID_BASE_EVENT_STATUS_ID_SUCCESS BASE_EVENT_STATUS_ID = 1  // Type: OCSF_VALUE; EnumValue: 1;
	BASE_EVENT_STATUS_ID_BASE_EVENT_STATUS_ID_FAILURE BASE_EVENT_STATUS_ID = 2  // EnumValue: 2; Type: OCSF_VALUE;
