...
const (
	...
	FINDINGS_CATEGORY_UID_FINDINGS_CATEGORY_UID_FINDINGS FINDINGS_CATEGORY_UID = 1 // Type: OCSF_VALUE; EnumValue: 2;
)
...
const (
	FINDINGS_STATUS_ID_FINDINGS_STATUS_ID_UNKNOWN FINDINGS_STATUS_ID = 0 // Type: OCSF_VALUE; EnumValue: 0;
	FINDINGS_STATUS_ID_FINDINGS_STATUS_ID_FAILURE FINDINGS_STATUS_ID = 1 // Type: OCSF_VALUE; EnumValue: 2;
	FINDINGS_STATUS_ID_FINDINGS_STATUS_ID_OTHER   FINDINGS_STATUS_ID = 2 // Type: OCSF_VALUE; EnumValue: 99;
	FINDINGS_STATUS_ID_FINDINGS_STATUS_ID_SUCCESS FINDINGS_STATUS_ID = 3 // Type: OCSF_VALUE; EnumValue: 1;
)
...
const (
	...
	FINDINGS_ACTIVITY_ID_FINDINGS_ACTIVITY_ID_OTHER   FINDINGS_ACTIVITY_ID = 2 // Type: OCSF_VALUE; EnumValue: 99;
	FINDINGS_ACTIVITY_ID_FINDINGS_ACTIVITY_ID_UPDATE  FINDINGS_ACTIVITY_ID = 3 // Type: OCSF_VALUE; EnumValue: 2;
)
...
var (
	FINDINGS_ACTIVITY_ID_name = map[int32]string{
		...
		2: "FINDINGS_ACTIVITY_ID_OTHER",
		3: "FINDINGS_ACTIVITY_ID_UPDATE",
	}
	FINDINGS_ACTIVITY_ID_value = map[string]int32{
		"FINDINGS_ACTIVITY_ID_UNKNOWN": 0,
		"FINDINGS_ACTIVITY_ID_CREATE":  1,
		"FINDINGS_ACTIVITY_ID_OTHER":   2,
		"FINDINGS_ACTIVITY_ID_UPDATE":  3,
	}
)
...
const (
	SECURITY_FINDING_TYPE_UID_SECURITY_FINDING_TYPE_UID_SECURITY_FINDING_UNKNOWN SECURITY_FINDING_TYPE_UID = 0 // Type: OCSF_VALUE; EnumValue: 200100;
	SECURITY_FINDING_TYPE_UID_SECURITY_FINDING_TYPE_UID_SECURITY_FINDING_CREATE  SECURITY_FINDING_TYPE_UID = 1 // Type: OCSF_VALUE; EnumValue: 200101;
	SECURITY_FINDING_TYPE_UID_SECURITY_FINDING_TYPE_UID_SECURITY_FINDING_OTHER   SECURITY_FINDING_TYPE_UID = 2 // Type: OCSF_VALUE; EnumValue: 200199;
	SECURITY_FINDING_TYPE_UID_SECURITY_FINDING_TYPE_UID_SECURITY_FINDING_UPDATE  SECURITY_FINDING_TYPE_UID = 3 // Type: OCSF_VALUE; EnumValue: 200102;
)

// Enum value maps for SECURITY_FINDING_TYPE_UID.
var (
	SECURITY_FINDING_TYPE_UID_name = map[int32]string{
		0: "SECURITY_FINDING_TYPE_UID_SECURITY_FINDING_UNKNOWN",
		1: "SECURITY_FINDING_TYPE_UID_SECURITY_FINDING_CREATE",
		2: "SECURITY_FINDING_TYPE_UID_SECURITY_FINDING_OTHER",
		3: "SECURITY_FINDING_TYPE_UID_SECURITY_FINDING_UPDATE",
	}
	SECURITY_FINDING_TYPE_UID_value = map[string]int32{
		"SECURITY_FINDING_TYPE_UID_SECURITY_FINDING_UNKNOWN": 0,
		"SECURITY_FINDING_TYPE_UID_SECURITY_FINDING_CREATE":  1,
		"SECURITY_FINDING_TYPE_UID_SECURITY_FINDING_OTHER":   2,
		"SECURITY_FINDING_TYPE_UID_SECURITY_FINDING_UPDATE":  3,
	}
)
...
const (
	...
	SECURITY_FINDING_IMPACT_ID_SECURITY_FINDING_IMPACT_ID_CRITICAL SECURITY_FINDING_IMPACT_ID = 1 // Type: OCSF_VALUE; EnumValue: 4;
	SECURITY_FINDING_IMPACT_ID_SECURITY_FINDING_IMPACT_ID_HIGH     SECURITY_FINDING_IMPACT_ID = 2 // EnumValue: 3; Type: OCSF_VALUE;
	SECURITY_FINDING_IMPACT_ID_SECURITY_FINDING_IMPACT_ID_LOW      SECURITY_FINDING_IMPACT_ID = 3 // Type: OCSF_VALUE; EnumValue: 1;
	SECURITY_FINDING_IMPACT_ID_SECURITY_FINDING_IMPACT_ID_MEDIUM   SECURITY_FINDING_IMPACT_ID = 4 // Type: OCSF_VALUE; EnumValue: 2;
	SECURITY_FINDING_IMPACT_ID_SECURITY_FINDING_IMPACT_ID_OTHER    SECURITY_FINDING_IMPACT_ID = 5 // Type: OCSF_VALUE; EnumValue: 99;
)
...
const (
	FINDINGS_TYPE_UID_FINDINGS_TYPE_UID_FINDINGS_UNKNOWN FINDINGS_TYPE_UID = 0 // Type: OCSF_VALUE; EnumValue: 200000;
	FINDINGS_TYPE_UID_FINDINGS_TYPE_UID_FINDINGS_CREATE  FINDINGS_TYPE_UID = 1 // Type: OCSF_VALUE; EnumValue: 200001;
	FINDINGS_TYPE_UID_FINDINGS_TYPE_UID_FINDINGS_OTHER   FINDINGS_TYPE_UID = 2 // Type: OCSF_VALUE; EnumValue: 200099;
	FINDINGS_TYPE_UID_FINDINGS_TYPE_UID_FINDINGS_UPDATE  FINDINGS_TYPE_UID = 3 // Type: OCSF_VALUE; EnumValue: 200002;
)

// Enum value maps for FINDINGS_TYPE_UID.
var (
	FINDINGS_TYPE_UID_name = map[int32]string{
		0: "FINDINGS_TYPE_UID_FINDINGS_UNKNOWN",
		1: "FINDINGS_TYPE_UID_FINDINGS_CREATE",
		2: "FINDINGS_TYPE_UID_FINDINGS_OTHER",
		3: "FINDINGS_TYPE_UID_FINDINGS_UPDATE",
	}
	FINDINGS_TYPE_UID_value = map[string]int32{
		"FINDINGS_TYPE_UID_FINDINGS_UNKNOWN": 0,
		"FINDINGS_TYPE_UID_FINDINGS_CREATE":  1,
		"FINDINGS_TYPE_UID_FINDINGS_OTHER":   2,
		"FINDINGS_TYPE_UID_FINDINGS_UPDATE":  3,
	}
)
...
const (
	...
	SECURITY_FINDING_STATUS_ID_SECURITY_FINDING_STATUS_ID_FAILURE SECURITY_FINDING_STATUS_ID = 1 // Type: OCSF_VALUE; EnumValue: 2;
	SECURITY_FINDING_STATUS_ID_SECURITY_FINDING_STATUS_ID_OTHER   SECURITY_FINDING_STATUS_ID = 2 // Type: OCSF_VALUE; EnumValue: 99;
	SECURITY_FINDING_STATUS_ID_SECURITY_FINDING_STATUS_ID_SUCCESS SECURITY_FINDING_STATUS_ID = 3 // Type: OCSF_VALUE; EnumValue: 1;
)
...
const (
	...
	SECURITY_FINDING_RISK_LEVEL_ID_SECURITY_FINDING_RISK_LEVEL_ID_CRITICAL SECURITY_FINDING_RISK_LEVEL_ID = 1 // Type: OCSF_VALUE; EnumValue: 4;
	SECURITY_FINDING_RISK_LEVEL_ID_SECURITY_FINDING_RISK_LEVEL_ID_HIGH     SECURITY_FINDING_RISK_LEVEL_ID = 2 // Type: OCSF_VALUE; EnumValue: 3;
	SECURITY_FINDING_RISK_LEVEL_ID_SECURITY_FINDING_RISK_LEVEL_ID_INFO     SECURITY_FINDING_RISK_LEVEL_ID = 3 // Type: OCSF_VALUE; EnumValue: 0;
	SECURITY_FINDING_RISK_LEVEL_ID_SECURITY_FINDING_RISK_LEVEL_ID_LOW      SECURITY_FINDING_RISK_LEVEL_ID = 4 // Type: OCSF_VALUE; EnumValue: 1;
	SECURITY_FINDING_RISK_LEVEL_ID_SECURITY_FINDING_RISK_LEVEL_ID_MEDIUM   SECURITY_FINDING_RISK_LEVEL_ID = 5 // Type: OCSF_VALUE; EnumValue: 2;
)
...
const (
	...
	SECURITY_FINDING_CONFIDENCE_ID_SECURITY_FINDING_CONFIDENCE_ID_HIGH    SECURITY_FINDING_CONFIDENCE_ID = 1 // Type: OCSF_VALUE; EnumValue: 3;
	SECURITY_FINDING_CONFIDENCE_ID_SECURITY_FINDING_CONFIDENCE_ID_LOW     SECURITY_FINDING_CONFIDENCE_ID = 2 // Type: OCSF_VALUE; EnumValue: 1;
	SECURITY_FINDING_CONFIDENCE_ID_SECURITY_FINDING_CONFIDENCE_ID_MEDIUM  SECURITY_FINDING_CONFIDENCE_ID = 3 // Type: OCSF_VALUE; EnumValue: 2;
	SECURITY_FINDING_CONFIDENCE_ID_SECURITY_FINDING_CONFIDENCE_ID_OTHER   SECURITY_FINDING_CONFIDENCE_ID = 4 // Type: OCSF_VALUE; EnumValue: 99;
)
...
const (
	...
	SECURITY_FINDING_STATE_ID_SECURITY_FINDING_STATE_ID_IN_PROGRESS SECURITY_FINDING_STATE_ID = 1 // Type: OCSF_VALUE; EnumValue: 2;
	SECURITY_FINDING_STATE_ID_SECURITY_FINDING_STATE_ID_NEW         SECURITY_FINDING_STATE_ID = 2 // Type: OCSF_VALUE; EnumValue: 1;
	SECURITY_FINDING_STATE_ID_SECURITY_FINDING_STATE_ID_OTHER       SECURITY_FINDING_STATE_ID = 3 // Type: OCSF_VALUE; EnumValue: 99;
	SECURITY_FINDING_STATE_ID_SECURITY_FINDING_STATE_ID_RESOLVED    SECURITY_FINDING_STATE_ID = 4 // EnumValue: 4; Type: OCSF_VALUE;
	SECURITY_FINDING_STATE_ID_SECURITY_FINDING_STATE_ID_SUPPRESSED  SECURITY_FINDING_STATE_ID = 5 // Type: OCSF_VALUE; EnumValue: 3;
)
...
const (
	...
	SECURITY_FINDING_CATEGORY_UID_SECURITY_FINDING_CATEGORY_UID_FINDINGS SECURITY_FINDING_CATEGORY_UID = 1 // Type: OCSF_VALUE; EnumValue: 2;
)
...
const (
	...
	SECURITY_FINDING_CLASS_UID_SECURITY_FINDING_CLASS_UID_SECURITY_FINDING SECURITY_FINDING_CLASS_UID = 1 // Type: OCSF_VALUE; EnumValue: 2001;
)
...
var (
	SECURITY_FINDING_CLASS_UID_name = map[int32]string{
		...
		1: "SECURITY_FINDING_CLASS_UID_SECURITY_FINDING",
	}
	SECURITY_FINDING_CLASS_UID_value = map[string]int32{
		"SECURITY_FINDING_CLASS_UID_UNKNOWN":          0,
		"SECURITY_FINDING_CLASS_UID_SECURITY_FINDING": 1,
	}
)
...
const (
	...
	SECURITY_FINDING_ACTIVITY_ID_SECURITY_FINDING_ACTIVITY_ID_OTHER   SECURITY_FINDING_ACTIVITY_ID = 2 // Type: OCSF_VALUE; EnumValue: 99;
	SECURITY_FINDING_ACTIVITY_ID_SECURITY_FINDING_ACTIVITY_ID_UPDATE  SECURITY_FINDING_ACTIVITY_ID = 3 // Type: OCSF_VALUE; EnumValue: 2;
)
...
var (
	SECURITY_FINDING_ACTIVITY_ID_name = map[int32]string{
		...
		2: "SECURITY_FINDING_ACTIVITY_ID_OTHER",
		3: "SECURITY_FINDING_ACTIVITY_ID_UPDATE",
	}
	SECURITY_FINDING_ACTIVITY_ID_value = map[string]int32{
		...
		"SECURITY_FINDING_ACTIVITY_ID_OTHER":   2,
		"SECURITY_FINDING_ACTIVITY_ID_UPDATE":  3,
	}
)
...
const (
	FINDINGS_SEVERITY_ID_FINDINGS_SEVERITY_ID_UNKNOWN       FINDINGS_SEVERITY_ID = 0 // EnumValue: 0; Type: OCSF_VALUE;
	FINDINGS_SEVERITY_ID_FINDINGS_SEVERITY_ID_CRITICAL      FINDINGS_SEVERITY_ID = 1 // Type: OCSF_VALUE; EnumValue: 5;
	FINDINGS_SEVERITY_ID_FINDINGS_SEVERITY_ID_FATAL         FINDINGS_SEVERITY_ID = 2 // Type: OCSF_VALUE; EnumValue: 6;
	FINDINGS_SEVERITY_ID_FINDINGS_SEVERITY_ID_HIGH          FINDINGS_SEVERITY_ID = 3 // Type: OCSF_VALUE; EnumValue: 4;
	FINDINGS_SEVERITY_ID_FINDINGS_SEVERITY_ID_INFORMATIONAL FINDINGS_SEVERITY_ID = 4 // Type: OCSF_VALUE; EnumValue: 1;
	FINDINGS_SEVERITY_ID_FINDINGS_SEVERITY_ID_LOW           FINDINGS_SEVERITY_ID = 5 // Type: OCSF_VALUE; EnumValue: 2;
	FINDINGS_SEVERITY_ID_FINDINGS_SEVERITY_ID_MEDIUM        FINDINGS_SEVERITY_ID = 6 // Type: OCSF_VALUE; EnumValue: 3;
	FINDINGS_SEVERITY_ID_FINDINGS_SEVERITY_ID_OTHER         FINDINGS_SEVERITY_ID = 7 // Type: OCSF_VALUE; EnumValue: 99;
)
...
const (
	...
	SECURITY_FINDING_SEVERITY_ID_SECURITY_FINDING_SEVERITY_ID_CRITICAL      SECURITY_FINDING_SEVERITY_ID = 1 // Type: OCSF_VALUE; EnumValue: 5;
	SECURITY_FINDING_SEVERITY_ID_SECURITY_FINDING_SEVERITY_ID_FATAL         SECURITY_FINDING_SEVERITY_ID = 2 // Type: OCSF_VALUE; EnumValue: 6;
	SECURITY_FINDING_SEVERITY_ID_SECURITY_FINDING_SEVERITY_ID_HIGH          SECURITY_FINDING_SEVERITY_ID = 3 // Type: OCSF_VALUE; EnumValue: 4;
	SECURITY_FINDING_SEVERITY_ID_SECURITY_FINDING_SEVERITY_ID_INFORMATIONAL SECURITY_FINDING_SEVERITY_ID = 4 // Type: OCSF_VALUE; EnumValue: 1;
	SECURITY_FINDING_SEVERITY_ID_SECURITY_FINDING_SEVERITY_ID_LOW           SECURITY_FINDING_SEVERITY_ID = 5 // Type: OCSF_VALUE; EnumValue: 2;
	SECURITY_FINDING_SEVERITY_ID_SECURITY_FINDING_SEVERITY_ID_MEDIUM        SECURITY_FINDING_SEVERITY_ID = 6 // Type: OCSF_VALUE; EnumValue: 3;
	SECURITY_FINDING_SEVERITY_ID_SECURITY_FINDING_SEVERITY_ID_OTHER         SECURITY_FINDING_SEVERITY_ID = 7 // Type: OCSF_VALUE; EnumValue: 99;
)
...
const (
	...
	FINDINGS_CLASS_UID_FINDINGS_CLASS_UID_FINDINGS FINDINGS_CLASS_UID = 1 // Type: OCSF_VALUE; EnumValue: 2000;
)
...
var file_ocsf_v1_0_0_events_findings_enums_enums_proto_rawDesc = []byte{
	...
	,
	...
	0x5f, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x00, 0x12, 0x35, 0x0a, 0x31, 0x53, 0x45,
	...
	0x01, 0x12, 0x34, 0x0a, 0x30, 0x53, 0x45, 0x43, 0x55, 0x52, 0x49, 0x54, 0x59, 0x5f, 0x46, 0x49,
	...
	0x4f, 0x54, 0x48, 0x45, 0x52, 0x10, 0x02, 0x12, 0x35, 0x0a, 0x31, 0x53, 0x45, 0x43, 0x55, 0x52,
	...
	0x4e, 0x44, 0x49, 0x4e, 0x47, 0x5f, 0x55, 0x50, 0x44, 0x41, 0x54, 0x45, 0x10, 0x03, 0x2a, 0x83,
	...
	0x4f, 0x57, 0x4e, 0x10, 0x00, 0x12, 0x27, 0x0a, 0x23, 0x53, 0x45, 0x43, 0x55, 0x52, 0x49, 0x54,
	...
	0x0a, 0x1f, 0x53, 0x45, 0x43, 0x55, 0x52, 0x49, 0x54, 0x59, 0x5f, 0x46, 0x49, 0x4e, 0x44, 0x49,
	0x4e, 0x47, 0x5f, 0x49, 0x4d, 0x50, 0x41, 0x43, 0x54, 0x5f, 0x49, 0x44, 0x5f, 0x48, 0x49, 0x47,
	0x48, 0x10, 0x02, 0x12, 0x22, 0x0a, 0x1e, 0x53, 0x45, 0x43, 0x55, 0x52, 0x49, 0x54, 0x59, 0x5f,
	0x46, 0x49, 0x4e, 0x44, 0x49, 0x4e, 0x47, 0x5f, 0x49, 0x4d, 0x50, 0x41, 0x43, 0x54, 0x5f, 0x49,
	0x44, 0x5f, 0x4c, 0x4f, 0x57, 0x10, 0x03, 0x12, 0x25, 0x0a, 0x21, 0x53, 0x45, 0x43, 0x55, 0x52,
	0x49, 0x54, 0x59, 0x5f, 0x46, 0x49, 0x4e, 0x44, 0x49, 0x4e, 0x47, 0x5f, 0x49, 0x4d, 0x50, 0x41,
	0x43, 0x54, 0x5f, 0x49, 0x44, 0x5f, 0x4d, 0x45, 0x44, 0x49, 0x55, 0x4d, 0x10, 0x04, 0x12, 0x24,
	...
	,
	...
	,
	...
	0x44, 0x5f, 0x48, 0x49, 0x47, 0x48, 0x10, 0x02, 0x12, 0x27, 0x0a, 0x23, 0x53, 0x45, 0x43, 0x55,
	...
	0x03, 0x12, 0x26, 0x0a, 0x22, 0x53, 0x45, 0x43, 0x55, 0x52, 0x49, 0x54, 0x59, 0x5f, 0x46, 0x49,
	0x4e, 0x44, 0x49, 0x4e, 0x47, 0x5f, 0x52, 0x49, 0x53, 0x4b, 0x5f, 0x4c, 0x45, 0x56, 0x45, 0x4c,
	0x5f, 0x49, 0x44, 0x5f, 0x4c, 0x4f, 0x57, 0x10, 0x04, 0x12, 0x29, 0x0a, 0x25, 0x53, 0x45, 0x43,
	...
	,
	...
	0x44, 0x5f, 0x4f, 0x54, 0x48, 0x45, 0x52, 0x10, 0x04, 0x2a, 0x87, 0x02, 0x0a, 0x19, 0x53, 0x45,
	0x43, 0x55, 0x52, 0x49, 0x54, 0x59, 0x5f, 0x46, 0x49, 0x4e, 0x44, 0x49, 0x4e, 0x47, 0x5f, 0x53,
	0x54, 0x41, 0x54, 0x45, 0x5f, 0x49, 0x44, 0x12, 0x25, 0x0a, 0x21, 0x53, 0x45, 0x43, 0x55, 0x52,
	0x49, 0x54, 0x59, 0x5f, 0x46, 0x49, 0x4e, 0x44, 0x49, 0x4e, 0x47, 0x5f, 0x53, 0x54, 0x41, 0x54,
	...
	,
	...
	0x5f, 0x46, 0x49, 0x4e, 0x44, 0x49, 0x4e, 0x47, 0x53, 0x10, 0x01, 0x2a, 0x75, 0x0a, 0x1a, 0x53,
	0x45, 0x43, 0x55, 0x52, 0x49, 0x54, 0x59, 0x5f, 0x46, 0x49, 0x4e, 0x44, 0x49, 0x4e, 0x47, 0x5f,
	0x43, 0x4c, 0x41, 0x53, 0x53, 0x5f, 0x55, 0x49, 0x44, 0x12, 0x26, 0x0a, 0x22, 0x53, 0x45, 0x43,
	...
	0x00, 0x12, 0x2f, 0x0a, 0x2b, 0x53, 0x45, 0x43, 0x55, 0x52, 0x49, 0x54, 0x59, 0x5f, 0x46, 0x49,
	0x4e, 0x44, 0x49, 0x4e, 0x47, 0x5f, 0x43, 0x4c, 0x41, 0x53, 0x53, 0x5f, 0x55, 0x49, 0x44, 0x5f,
	0x53, 0x45, 0x43, 0x55, 0x52, 0x49, 0x54, 0x59, 0x5f, 0x46, 0x49, 0x4e, 0x44, 0x49, 0x4e, 0x47,
	0x10, 0x01, 0x2a, 0xc2, 0x01, 0x0a, 0x1c, 0x53, 0x45, 0x43, 0x55, 0x52, 0x49, 0x54, 0x59, 0x5f,
	...
	0x45, 0x41, 0x54, 0x45, 0x10, 0x01, 0x12, 0x26, 0x0a, 0x22, 0x53, 0x45, 0x43, 0x55, 0x52, 0x49,
	...
	,
	...
	0x44, 0x5f, 0x46, 0x41, 0x54, 0x41, 0x4c, 0x10, 0x02, 0x12, 0x25, 0x0a, 0x21, 0x53, 0x45, 0x43,
	...
	0x44, 0x49, 0x4e, 0x47, 0x5f, 0x53, 0x45, 0x56, 0x45, 0x52, 0x49, 0x54, 0x59, 0x5f, 0x49, 0x44,
	0x5f, 0x4c, 0x4f, 0x57, 0x10, 0x05, 0x12, 0x27, 0x0a, 0x23, 0x53, 0x45, 0x43, 0x55, 0x52, 0x49,
	0x54, 0x59, 0x5f, 0x46, 0x49, 0x4e, 0x44, 0x49, 0x4e, 0x47, 0x5f, 0x53, 0x45, 0x56, 0x45, 0x52,
	...
	0x4f, 0x54, 0x48, 0x45, 0x52, 0x10, 0x07, 0x2a, 0x55, 0x0a, 0x12, 0x46, 0x49, 0x4e, 0x44, 0x49,
	0x4e, 0x47, 0x53, 0x5f, 0x43, 0x4c, 0x41, 0x53, 0x53, 0x5f, 0x55, 0x49, 0x44, 0x12, 0x1e, 0x0a,
	0x1a, 0x46, 0x49, 0x4e, 0x44, 0x49, 0x4e, 0x47, 0x53, 0x5f, 0x43, 0x4c, 0x41, 0x53, 0x53, 0x5f,
	...
	0x55, 0x49, 0x44, 0x5f, 0x46, 0x49, 0x4e, 0x44, 0x49, 0x4e, 0x47, 0x53, 0x10, 0x01, 0x42, 0x9f,
	0x02, 0x0a, 0x25, 0x63, 0x6f, 0x6d, 0x2e, 0x6f, 0x63, 0x73, 0x66, 0x2e, 0x76, 0x31, 0x5f, 0x30,
	0x5f, 0x30, 0x2e, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x2e, 0x66, 0x69, 0x6e, 0x64, 0x69, 0x6e,
	0x67, 0x73, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x0a, 0x45, 0x6e, 0x75, 0x6d, 0x73, 0x50,
	...
	,
...
var file_ocsf_v1_0_0_events_findings_enums_enums_proto_goTypes = []interface{}{
	(FINDINGS_CATEGORY_UID)(0),          // 0: ocsf.v1_0_0.events.findings.enums.FINDINGS_CATEGORY_UID
	(FINDINGS_STATUS_ID)(0),             // 1: ocsf.v1_0_0.events.findings.enums.FINDINGS_STATUS_ID
	(FINDINGS_ACTIVITY_ID)(0),           // 2: ocsf.v1_0_0.events.findings.enums.FINDINGS_ACTIVITY_ID
	(SECURITY_FINDING_TYPE_UID)(0),      // 3: ocsf.v1_0_0.events.findings.enums.SECURITY_FINDING_TYPE_UID
	(SECURITY_FINDING_IMPACT_ID)(0),     // 4: ocsf.v1_0_0.events.findings.enums.SECURITY_FINDING_IMPACT_ID
	(FINDINGS_TYPE_UID)(0),              // 5: ocsf.v1_0_0.events.findings.enums.FINDINGS_TYPE_UID
	(SECURITY_FINDING_STATUS_ID)(0),     // 6: ocsf.v1_0_0.events.findings.enums.SECURITY_FINDING_STATUS_ID
	(SECURITY_FINDING_RISK_LEVEL_ID)(0), // 7: ocsf.v1_0_0.events.findings.enums.SECURITY_FINDING_RISK_LEVEL_ID
	(SECURITY_FINDING_CONFIDENCE_ID)(0), // 8: ocsf.v1_0_0.events.findings.enums.SECURITY_FINDING_CONFIDENCE_ID
	(SECURITY_FINDING_STATE_ID)(0),      // 9: ocsf.v1_0_0.events.findings.enums.SECURITY_FINDING_STATE_ID
	(SECURITY_FINDING_CATEGORY_UID)(0),  // 10: ocsf.v1_0_0.events.findings.enums.SECURITY_FINDING_CATEGORY_UID
	(SECURITY_FINDING_CLASS_UID)(0),     // 11: ocsf.v1_0_0.events.findings.enums.SECURITY_FINDING_CLASS_UID
	(SECURITY_FINDING_ACTIVITY_ID)(0),   // 12: ocsf.v1_0_0.events.findings.enums.SECURITY_FINDING_ACTIVITY_ID
	(FINDINGS_SEVERITY_ID)(0),           // 13: ocsf.v1_0_0.events.findings.enums.FINDINGS_SEVERITY_ID
	(SECURITY_FINDING_SEVERITY_ID)(0),   // 14: ocsf.v1_0_0.events.findings.enums.SECURITY_FINDING_SEVERITY_ID
	(FINDINGS_CLASS_UID)(0),             // 15: ocsf.v1_0_0.events.findings.enums.FINDINGS_CLASS_UID
}
