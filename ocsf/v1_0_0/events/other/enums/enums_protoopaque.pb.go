...
const file_ocsf_v1_0_0_events_other_enums_enums_proto_rawDesc = "" +
	"\n" +
	"*ocsf/v1_0_0/events/other/enums/enums.proto\x12\x1eocsf.v1_0_0.events.other.enums*^\n" +
	...
	"\"com.ocsf.v1_0_0.events.other.enumsB\n" +
	"EnumsProtoP\x01ZEgithub.com/valllabh/ocsf-schema-golang/ocsf/v1_0_0/events/other/enums\xa2\x02\x05OVEOE\xaa\x02\x1cOcsf.V100.Events.Other.Enums\xca\x02\x1cOcsf\\V100\\Events\\Other\\Enums\xe2\x02(Ocsf\\V100\\Events\\Other\\Enums\\GPBMetadata\xea\x02 Ocsf::V100::Events::Other::Enumsb\x06proto3"

var file_ocsf_v1_0_0_events_other_enums_enums_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
var file_ocsf_v1_0_0_events_other_enums_enums_proto_goTypes = []any{
	...
	(BASE_EVENT_CLASS_UID)(0),    // 2: ocsf.v1_0_0.events.other.enums.BASE_EVENT_CLASS_UID
	(BASE_EVENT_SEVERITY_ID)(0),  // 3: ocsf.v1_0_0.events.other.enums.BASE_EVENT_SEVERITY_ID
...
func file_ocsf_v1_0_0_events_other_enums_enums_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_ocsf_v1_0_0_events_other_enums_enums_proto_rawDesc), len(file_ocsf_v1_0_0_events_other_enums_enums_proto_rawDesc)),
			NumEnums:      5,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
